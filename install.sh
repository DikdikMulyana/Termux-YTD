...
# Coded by: DikdikMulyana (You dont become a coder by just changing the credits)
# Github: https://github.com/Dikdikmulyana/Termux-YTD
# Date : 6/3/2022
...
echo -e "\e[033m" "For More Awesome and Useful Tool like this Visit My website ©www.dikdikmulyana.my.id"
